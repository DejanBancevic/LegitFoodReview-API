...
namespace LegitFoodReviewApp.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        public IActionResult GetCountries() // GET celu listu Food-a
        {
        ...
        public IActionResult GetCountry(int countryId)  // GET jednog Food-a po Id
        {
        ...
        public IActionResult CreateCountry([FromBody] CountryDto countryCreate)
        {
            ...
            if (country != null)
            {
                ModelState.AddModelError("", "Vec postoji drzava");
